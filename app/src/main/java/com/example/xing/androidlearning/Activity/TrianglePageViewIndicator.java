...
import com.example.xing.androidlearning.fragment.VpSimpleFragment;
import com.example.xing.androidlearning.customview.TriangleIndicator;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;

public class TrianglePageViewIndicator extends FragmentActivity {
